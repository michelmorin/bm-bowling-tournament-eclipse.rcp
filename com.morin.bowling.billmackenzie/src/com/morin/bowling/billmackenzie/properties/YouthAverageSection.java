...
public class YouthAverageSection extends AbstractPropertySection implements VerifyListener {
    ...
    private ModifyListener listener = new ModifyListener() {
        ...
        public void modifyText(ModifyEvent arg0) {
			...
			if (currentTeam != null)
			{
				currentTeam.getYouth().setAverage(Integer.valueOf(labelText.getText()).intValue());
...
public void inputChanged(Object oldInput, Object newInput) {
    ...
    public void refresh() {
    	...
    	if ( currentTeam != null)
    	{
    		labelText.setText(String.valueOf(currentTeam.getYouth().getAverage()));
    	}
        labelText.addModifyListener(listener);
        labelText.addVerifyListener(this);
    }
