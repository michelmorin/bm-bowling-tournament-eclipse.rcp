...
public class YouthScratchPoolSection
...
public void inputChanged(Object oldInput, Object newInput) {
    ...
    public void createControls(Composite parent,
        ...
        radioYesListener = new SelectionAdapter() {
            public void widgetSelected(SelectionEvent e) {
                if ( radioYes.getSelection() == true)
                {
        			...
        			if (currentTeam != null)
        			{
        				currentTeam.getYouth().setScratchPot(true);
        ...
        radioNoListener = new SelectionAdapter() {
            public void widgetSelected(SelectionEvent e) {
    			...
    			if (currentTeam != null)
    			{
    				currentTeam.getYouth().setScratchPot(false);
    				tournament.updateTeam(currentTeam);
    			}   
            }
        };
    ...
    public void refresh() {
    	...
    	if ( currentTeam != null)
    	{
    			radioYes.setSelection(currentTeam.getYouth().isScratchPot());
    			radioNo.setSelection(!currentTeam.getYouth().isScratchPot());
    	}
