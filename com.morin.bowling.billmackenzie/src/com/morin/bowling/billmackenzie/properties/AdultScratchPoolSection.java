...
public class AdultScratchPoolSection
...
public void inputChanged(Object oldInput, Object newInput) {
    ...
    public void createControls(Composite parent,
        ...
        radioYesListener = new SelectionAdapter() {
            public void widgetSelected(SelectionEvent e) {
                if ( radioYes.getSelection() == true)
                {
        			...
        			if (currentTeam != null)
        			{
        				currentTeam.getAdult().setScratchPot(true);
        ...
        radioNoListener = new SelectionAdapter() {
            public void widgetSelected(SelectionEvent e) {
    			...
    			if (currentTeam != null)
    			{
    				currentTeam.getAdult().setScratchPot(false);
    				tournament.updateTeam(currentTeam);
    			}   
            }
        };
        ...
        CLabel labelLabel = getWidgetFactory().createCLabel(composite, "Scratch Pool:"); //$NON-NLS-1$
        data = new FormData();
    ...
    public void refresh() {
    	...
    	if ( currentTeam != null)
    	{
    			radioYes.setSelection(currentTeam.getAdult().isScratchPot());
    			radioNo.setSelection(!currentTeam.getAdult().isScratchPot());
    	}
