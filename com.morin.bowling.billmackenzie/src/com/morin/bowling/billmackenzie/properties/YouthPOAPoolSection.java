...
public class YouthPOAPoolSection
...
public void inputChanged(Object oldInput, Object newInput) {
    ...
    public void createControls(Composite parent,
        ...
        radioYesListener = new SelectionAdapter() {
            public void widgetSelected(SelectionEvent e) {
                if ( radioYes.getSelection() == true)
                {
        			...
        			if (currentTeam != null)
        			{
        				currentTeam.getYouth().setPoaPot(true);
        ...
        radioNoListener = new SelectionAdapter() {
            public void widgetSelected(SelectionEvent e) {
    			...
    			if (currentTeam != null)
    			{
    				currentTeam.getYouth().setPoaPot(false);
    				tournament.updateTeam(currentTeam);
    			}   
            }
        };
    ...
    public void refresh() {
    	...
    	if ( currentTeam != null)
    	{
    			radioYes.setSelection(currentTeam.getYouth().isPoaPot());
    			radioNo.setSelection(!currentTeam.getYouth().isPoaPot());
    	}
