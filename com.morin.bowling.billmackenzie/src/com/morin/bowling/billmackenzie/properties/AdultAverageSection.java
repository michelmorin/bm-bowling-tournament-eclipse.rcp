...
public class AdultAverageSection extends AbstractPropertySection implements VerifyListener {
    ...
    private ModifyListener listener = new ModifyListener() {
        ...
        public void modifyText(ModifyEvent arg0) {
			...
			if (currentTeam != null)
			{
				currentTeam.getAdult().setAverage(Integer.valueOf(labelText.getText()).intValue());
...
public void inputChanged(Object oldInput, Object newInput) {
    ...
    public void createControls(Composite parent,
        ...
        labelText.addVerifyListener(this);

        CLabel labelLabel = getWidgetFactory().createCLabel(composite, "Average:"); //$NON-NLS-1$
        data = new FormData();
    ...
    public void refresh() {
    	...
    	labelText.removeVerifyListener(this);
    	if ( currentTeam != null)
    	{
    		labelText.setText(String.valueOf(currentTeam.getAdult().getAverage()));
    	}
        labelText.addModifyListener(listener);
        labelText.addVerifyListener(this);
    }
